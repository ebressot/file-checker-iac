...
set fileName=tsx-60-index-%effectiveDateMonth%-%effectiveDateDay%-%effectiveDateYear%-fundamental.csv
set localPath=C:\Users\Eric\Downloads\
set remotePath=TSX/TXSX-Fundamental/
set effectiveDate=%effectiveDateYear%-%effectiveDateMonth%-%effectiveDateDay%
set feedName=TXSX-Fundamental
set feedDescription=TSX 60 Index Fundamental
set sourceName=TSX
